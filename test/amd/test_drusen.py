...
@pytest.mark.parametrize('text, exp_size_le, exp_size_re, exp_type_le, exp_type_re, note_date', [
    ...
    ('OD: extensive drusen', -1, 3, -1, 4, None),
    ('OD: 10/2/2011 extensive drusen', -1, -1, -1, -1, datetime.date(2011, 10, 9)),
    ('OD: 10/2/2011 no drusen 10/9/2011 extensive drusen', -1, 3, -1, 4, datetime.date(2011, 10, 9)),
    ('OD: 10/9/2011 no drusen 10/2/2011 extensive drusen', -1, 0, -1, 0, datetime.date(2011, 10, 9)),
])
