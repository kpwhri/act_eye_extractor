...
_dme_yesno_extract_and_build_cases = [
    ...
    # In `get_previous_next_non_section` introduce new check under `if lat.is_section_start` to check for '-' before section start, if exists proceed as if not section.
